...
- `COG` no viene como campo separado: se deriva de `lat/lon` y se estabiliza con fusión con `HDG` (ponderado por `SOG`) para evitar ruido cuando la posición llega cuantizada.
